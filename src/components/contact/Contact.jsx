...
const Contact = () => {
    ...
    const sendEmail = (e) => {
        e.preventDefault();
        emailjs
          .sendForm('service_cuig8qi', 'template_vatpc7r', formref.current, {
            publicKey: 'go31vesQ0x-d2xvzJ',
          })
          .then(
            (result) => {
              setSuccess(true);
    ...
    <motion.div className="contact" variants={variants} initial="initial" whileInView="animate">
        <motion.div className="textContainer" variants={variants}>
            ...
            <motion.div className="item" variants={variants}>
                <h2>E-Mail</h2>
                <span>aviralchauhan018@gmail.com</span>
            </motion.div>
            <motion.div className="item" variants={variants}>
                <h2>Address</h2>
        ...
        <div className="formContainer">
            <motion.div className="phoneSVG" initial={{opacity:1}} whileInView={{opacity:0}} transition={{delay:3,duration:1}}>
                ...
                <textarea placeholder="Message" rows={8} required name="message"/>
